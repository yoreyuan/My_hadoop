...
public class Util {
     ...
     *
     * @author: yore
     * @param outPath 输出的文件的路径
     * @return java.io.BufferedReader 文件读取的输出流对象
     * @date: 2018/7/4 14:26
     */
    public static OutputStreamWriter getOutPutStreamWriter(String outPath/*, String charsetName*/){
        // 读取文件的输入流对象
        OutputStreamWriter out = null;
        try {
            out = new OutputStreamWriter(new FileOutputStream(outPath, true), "UTF-8");
        } catch (Exception e){
